...
RAW_AUDIO_FILE = os.path.join(AUDIO_DIR, "raw.m4a")
BACKGROUND_AUDIO_FILE = os.path.join(AUDIO_DIR, "background.m4a")
VOCAL_AUDIO_FILE = os.path.join(AUDIO_DIR, "vocals.m4a")
